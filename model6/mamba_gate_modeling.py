...
class MambaMixer(nn.Module):
    ...
    def slow_forward(self, input_states):
        ...
        torch.save(input_states, f"../model6/layers_output/gate_mamba/input_states/input_states_layer_{self.layer_idx}.pt")
        # projected_states = self.in_proj(input_states).transpose(1, 2)                   # [batch,intermediate_size, seq_len]
        # scan_output, gate = projected_states.chunk(2, dim=1)
        gate = self.in_proj(input_states).transpose(1, 2)  
        gate = self.act(gate)
        gate = gate.contiguous()
        torch.save(gate, f"../model6/layers_output/gate_mamba/gate/gate_layer_{self.layer_idx}.pt")
        ...
        torch.save(scan_output, f"../model6/layers_output/gate_mamba/scan_output_before_gate_mul/scan_output_before_gate_mul_layer_{self.layer_idx}.pt")
        scan_output = scan_output * gate
        torch.save(scan_output, f"../model6/layers_output/gate_mamba/scan_output_after_gate_mul/scan_output_after_gate_mul_layer_{self.layer_idx}.pt")

        # 4. Final linear projection
        contextualized_states = self.out_proj(scan_output.transpose(1, 2))  # [batch, seq_len, hidden_size]
        torch.save(contextualized_states, f"../model6/layers_output/gate_mamba/contextualized_states/contextualized_states_layer_{self.layer_idx}.pt")
...
class MambaBlock(GradientCheckpointingLayer):
    ...
    def forward(
        ...
        torch.save(hidden_states, f"../model6/layers_output/gate_mamba/hidden_states_rsqrt/hidden_states_rsqrt_layer_{self.layer_idx}.pt")
...
class MambaModel_Gate(MambaPreTrainedModel_Gate):
    ...
    def forward(
        ...
        **kwargs,
        ...
        """
        torch.save(input_ids, "../model6/layers_output/gate_mamba/forward_model_input_ids/forward_model_input_ids_layer_0.pt")
        ...
        torch.save(inputs_embeds, "../model6/layers_output/gate_mamba/inputs_embeds/inputs_embeds_layer_0.pt")
